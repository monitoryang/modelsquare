/**
 * LivePreviewContent - Shared live video inference preview rendering.
 *
 * Encapsulates WebSocket connection, status UI, and VideoPlayer rendering
 * for real-time inference preview.  Used by LivePreviewModal (inside a
 * Modal wrapper) and can be embedded inline in other pages.
 *
...
const LivePreviewContent: React.FC<LivePreviewContentProps> = ({
  modelId,
  taskId,
  videoProgress,
}) => {
    ...
    <div>
      ...
      {hlsAvailable ? (
        ...
        <div style={{ textAlign: 'center', padding: '40px 0' }}>
          {wsConnected ? (
            <>
              <PlayCircleOutlined style={{ fontSize: 48, color: 'var(--color-cyan)', marginBottom: 16 }} />
              <div>
